...
/**
 * Object holding the metadata around the xform queue
 * 
 * @author Samuel Mbugua
 *
 */
public class XformsQueue {
	
	private Log log = LogFactory.getLog(this.getClass());
	private Integer xformQueueId;
    ...
    public boolean equals(Object obj) {
    	if (!(obj instanceof XformsQueue))
    		return false;
    	
    	XformsQueue other = (XformsQueue)obj;
    	
    	if (other.getXformQueueId() != null && getXformQueueId() != null)
    		return other.getXformQueueId().equals(xformQueueId);
	...
	public String getFormData() {
		...
		if (formData == null && fileSystemUrl != null) {
			...
			if (file.exists()) {
				...
				log.warn("File system url does not exist for xform queue item.  Url: '" + fileSystemUrl + "'");
			}
	...
	/**
	 * @return Returns the xformQueueId.
	 */
	public Integer getXformQueueId() {
		return xformQueueId;
	}

	/**
	 * @param xformQueueId The xformQueueId to set.
	 */
	public void setXformQueueId(Integer xformQueueId) {
		this.xformQueueId = xformQueueId;
	}
}
