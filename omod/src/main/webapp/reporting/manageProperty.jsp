...
<openmrs:htmlInclude file="/moduleResources/mclinic/jquery.jeditable.mini.js"/>

<openmrs:require privilege="Manage Connector" otherwise="/login.htm" redirect="/module/mclinic/reporting/manageProperty.form"/>
...
<div>
	<form action="" method="post">
		<fieldset>
			<legend><span><spring:message code="mclinic.cohortDefinition.header"/></span></legend>
			<ol>
				<li>
					<label for="definitionList"><spring:message code="mclinic.cohortDefinition.definitionList"/></label>
	...
	<fieldset>
		<legend><span><spring:message code="mclinic.cohortDefinition.property.header"/></span></legend>
		<table cellpadding="5px">
			<thead>
			<tr>
				<th class="header"><span><spring:message code="mclinic.cohortDefinition.property"/></span></th>
				<th class="header"><span><spring:message code="mclinic.cohortDefinition.propertyValue"/></span></th>
				<th class="header"><span><spring:message code="mclinic.cohortDefinition.propertyDescription"/></span></th>
			</tr>
			</thead>
			...
			<tr id="newPropertyRow" style='display: none;'>
				<form id="newProperty" method="post" action="">
					...
					<td><input type="button" id="saveProperty" value="<spring:message code='mclinic.cohortDefinition.saveProperty' />"/></td>
				</form>
			</tr>
			<tr id="addPropertyRow">
				<td><input type="button" id="addNew" value="<spring:message code='mclinic.cohortDefinition.newProperty' />"/></td>
			</tr>
			</tfoot>
		</table>
	</fieldset>
